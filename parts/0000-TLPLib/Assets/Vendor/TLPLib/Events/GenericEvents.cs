...
namespace Smooth.Events {
	...
	public struct GenericEvent<T1, T2, T3> {
		...
		/// The wrapped event.
		/// </summary>
		public event Act<T1, T2, T3> Handle;
	...
	public struct GenericEvent<T1, T2, T3, T4> {
		...
		/// The wrapped event.
		/// </summary>
		public event Act<T1, T2, T3, T4> Handle;
	...
	public struct GenericEvent<T1, T2, T3, T4, T5> {
		...
		/// The wrapped event.
		/// </summary>
		public event Act<T1, T2, T3, T4, T5> Handle;
	...
	public struct GenericEvent<T1, T2, T3, T4, T5, T6> {
		...
		/// The wrapped event.
		/// </summary>
		public event Act<T1, T2, T3, T4, T5, T6> Handle;
	...
	public struct GenericEvent<T1, T2, T3, T4, T5, T6, T7> {
		...
		/// The wrapped event.
		/// </summary>
		public event Act<T1, T2, T3, T4, T5, T6, T7> Handle;
	...
	public struct GenericEvent<T1, T2, T3, T4, T5, T6, T7, T8> {
		...
		/// The wrapped event.
		/// </summary>
		public event Act<T1, T2, T3, T4, T5, T6, T7, T8> Handle;
	...
	public struct GenericEvent<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
		...
		/// The wrapped event.
		/// </summary>
		public event Act<T1, T2, T3, T4, T5, T6, T7, T8, T9> Handle;
